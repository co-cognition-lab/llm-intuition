...
Posterior v2: "They share a degradation-recursive sensemaking loop — Phase D's judgment was bias, not discovery"
```

---

### PN Wealth Inheritance — "I'm the domain expert, but expert intuition can be the blind spot"
...
Posterior v2: "The metaphor itself may not fit — atomic decay vs. river/container"
```

---

### P2 Co-Cognition Map — "I don't know what I'll find"
...
```
Awaiting evidence: P2 has not closed. MERA has not been executed.
```
...
1. **Tri-source cross**: Ask the same question to two different LLMs — look for what they *both* missed
2. **A/B adversarial briefing**: Reformat your task as sharp challenges and send it again
